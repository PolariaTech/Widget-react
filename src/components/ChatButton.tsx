...
export function ChatButton({ onClick, hasUnread }: ChatButtonProps) {
  return (
    <button
      id="chat-button"
      onClick={onClick}
      className="fixed bottom-6 right-6 h-[60px] w-[60px] rounded-[18px] transition-transform hover:scale-105 active:scale-95 focus:outline-none focus:ring-2 focus:ring-[#00E5CC] focus:ring-offset-2 focus:ring-offset-transparent z-40 overflow-hidden flex items-center justify-center p-px cursor-pointer"
      style={{
        backgroundColor: '#040e14',
        backgroundImage: 'linear-gradient(135deg, rgba(0, 229, 204, 0.2) 0%, rgba(0, 85, 200, 0.15) 100%)',
      }}
